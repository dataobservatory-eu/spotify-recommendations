...
artists <- get_artists(spotify_artist_id)
...
```{r}
start_time <- Sys.time()
global_top_50 <- get_required_recommendations(
...
```{r}
start_time <- Sys.time()
french_post_rock <- get_required_recommendations(
...
```{r}
start_time <- Sys.time()
french_rock <- get_required_recommendations(
